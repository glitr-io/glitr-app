                    ...
                    <Col>
                        <TouchableOpacity
                            onPress={() => addMemeItem({
                                ...
                                style: {
                                    height: memeItems.find(({ type }) => type === 'CANVAS').style.height,
                                    width: memeItems.find(({ type }) => type === 'CANVAS').style.height,
                                    top: 0,
                                    left: 0
                                }
            ...
            <Draggable
                ...
                <Grid style={{ marginTop: 40 }}>
                    ...
                    <Row style={{ height: 60 }}>
                        <CommentInput
                            value="hello"
                            onSubmit={newTag => updateMetadata({
